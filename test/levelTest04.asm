...
left:
 ldx $1009		; check if player is in bottom half of screen
...
rightBot:
 ldx $1006		;load rows like normal
 cpx #$15		 ; check if x =21 (end of right)
 beq updateNewLocBot	 ; at end of screen right
...
up:
 ldx $1009		;check if player bottom half
 cpx #$00
 bne upBot
 ldx $1007		;top cols
...
getRowColFormBot:		;get coord in row +column for bototm
 ldy #$00
 ldx $1009			;1009 instead of 1007 b/c bottom
 jsr addCols
 tya
 clc
 adc $1006
...
collision:		 ; detect collision between B and C
 ...
 beq drawcoll
 cpy $100b			; check if character is enemy
